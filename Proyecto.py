...
def mi_auto_doc():
    Documentación = open('DG_Garbanzo_Fallas.txt', 'r')
    Texto = Documentación.read()
    print(Texto)
    Documentación.close()
mi_auto_doc()
...
#Ventana Boss 1 ==============================================================================================================================(Módulo adaptado)
def pantalla_boss1():
...
#Movimiento de izquierda a derecha------------------------------------------------------------------------(Módulo adaptado)
...
#Movimiento de derecha a izquierda-------------------------------------------------------------------------(Módulo adaptado)
...
#Embestida Boss 1 (módulo editado)-------------------------------------------------------------------------(Módulo adaptado)
...
#Movimiento vertical Boss1 (módulo editado)----------------------------------------------------------------(Módulo adaptado)
...
#Ventana Boss 2 ============================================================================================================================(Módulo adaptado)
def pantalla_boss2():
...
#Movimiento de horizontal del Jefe 2 -----------------------------------------------------------------------------(Módulo adaptado)
...
#Ventana Boss 3 ========================================================================================================================(Módulo adaptado)
def pantalla_boss3():
...
#Embestida Boss 3 (módulo editado)--------------------------------------------------------------------------------------(Módulo adaptado)
...
#Movimiento vertical  (módulo editado)---------------------------------------------------------------------------------(Módulo adaptado)
